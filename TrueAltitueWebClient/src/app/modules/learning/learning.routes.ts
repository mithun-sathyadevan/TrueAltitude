...
import { PerformanceInsightsPageComponent } from '../../pages/performance-insights/performance-insights-page.component';
...
export const LEARNING_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'performance-insights', component: PerformanceInsightsPageComponent },
    ],
  },
];